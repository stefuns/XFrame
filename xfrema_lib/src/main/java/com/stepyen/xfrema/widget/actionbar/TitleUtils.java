package com.stepyen.xfrema.widget.actionbar;
...
public final class TitleUtils {
     ...
     * @return
     */
    public static TitleBar initTitleBarDynamic(Context context, CharSequence title, View.OnClickListener listener) {
     ...
     * @return
     */
    public static TitleBar initTitleBarStyle(TitleBar titleBar, CharSequence title, View.OnClickListener listener) {
        titleBar.setImmersive(false)
                .setBackImageResource(R.drawable.xpage_ic_return_back)
                .setLeftClickListener(listener)
                .setTitle(title)
                .setBackgroundColor(Utils.resolveColor(titleBar.getContext(), R.attr.xframe_actionbar_color, Color.parseColor("#299EE3")));
        return titleBar;
    }
}
