 ...
 */
package com.stepyen.xfrema_lib.integration.lifecycle;
...
public class ActivityLifecycleForRxLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    /**
     * 从 {@link com.stepyen.xfrema_lib.base.BaseActivity} 中获得桥梁对象 {@code BehaviorSubject<ActivityEvent> mLifecycleSubject}
     *
