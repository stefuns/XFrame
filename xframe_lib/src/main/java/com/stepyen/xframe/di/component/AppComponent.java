 ...
 */
package com.stepyen.xframe.di.component;
...
import com.stepyen.xframe.di.module.AppModule;
...
/**
 * ================================================
 * 可通过 {@link XFrameUtils#obtainAppComponentFromContext(Context)} 拿到此接口的实现类
